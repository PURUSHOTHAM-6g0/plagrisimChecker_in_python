...
choice = int(input("Enter 0 for comparing folder with masterfile\nEnter 1 to check for plagiarism in two files\nEnter 2 to check for plagiarism in all files in folder\n"))
